...
if __name__ == "__main__":
    # Some testing
    references = [
        ["I am going to the store today to buy milk"],
        ["The dog bit his shoe, and he screamed"],
    ]
    hypotheses = [
        "Going to store is something I will do today",
        "The angry wolf tore at his shoe. He screamed!",
    ]
